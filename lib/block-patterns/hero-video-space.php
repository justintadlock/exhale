...
<div class="wp-block-buttons is-content-justification-center mt-12"><!-- wp:button {"style":{"typography":{"textTransform":"uppercase"},"border":{"radius":50}},"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline" style="text-transform:uppercase"><a class="wp-block-button__link" style="border-radius:50px">Read More</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
