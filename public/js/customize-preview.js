...
/* harmony import */ var _customize_preview_typography__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./customize-preview/typography */ "./resources/js/customize-preview/typography.js");
/* harmony import */ var _customize_preview_typography__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_customize_preview_typography__WEBPACK_IMPORTED_MODULE_1__);
/**
...
var settings = exhaleCustomizePreview.typographySettings;
var families = exhaleCustomizePreview.fontFamilies;
var loadedFonts = [];
Object.keys(settings).forEach(function (key) {
  ...
  wp.customize(setting.modNames.family, function (value) {
    value.bind(function (to) {
      ...
      document.body.style.setProperty('--wp--preset--font-family--' + setting.name, family.stack);
    });
  });
});
